...
import quiz_dataset from '../../data/questions.json';
...
async function main() {
	// Use the imported data with the defined type
	const questions_dataset: QuizDataset = quiz_dataset;

	// Insert the questions into the database
	for (const raw_question of questions_dataset.questions) {
		for (const question_permutation of generate_question_permutations(raw_question)) {
			...
			console.log(prismaQuestionData);
